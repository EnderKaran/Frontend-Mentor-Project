        ...
        {filteredProjects.length > 0 ? (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {filteredProjects.map((project) => (
              <Card 
                key={project.id} 
                className="flex flex-col overflow-hidden transition-all duration-300 bg-neutral-900 border-neutral-800 hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/10 group animate-in fade-in slide-in-from-bottom-4 duration-500"
              >
                {/* Image Area */}
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="p-4 mb-4 rounded-full bg-neutral-900 border border-neutral-800">
            ...
            <Button variant="link" onClick={resetFilters} className="mt-4 text-indigo-400">
              Clear all filters
            </Button>
          </div>
        )}
